...
excerpt: "레디스의 핵심개념, 특징, 사용 용도에 대해서 알아보자." 
categories:
    - Blog
tags:
    - 레디스
...
<img src='/assets/images/redis.png' width='700px' height='400px'/>
...
<img src='/assets/images/set.png' width='700px' height='400px'/>
...
<img src='/assets/images/sorted.png' width='700px' height='400px'/>

4. Hashes

- hash는 value 내에 field/string value 쌍으로 이루어진 테이블을 저장하는 데이타 구조체이다. RDBMS에서 PK 1개와 string 필드 하나로 이루어진 테이블이라고 이해하면 된다. 

<img src='/assets/images/hash.png' width='700px' height='400px'/>
...
<img src='/assets/images/list.png' width='700px' height='400px'/>
...
<img src='/assets/images/arc.png' width='700px' height='400px'/>
